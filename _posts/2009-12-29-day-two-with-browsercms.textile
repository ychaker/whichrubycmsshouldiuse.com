...
div(screenshot). !/images/event_type_screenshot.png(Event Type Screen Shot)!:/images/event_type_screenshot.png 

p. And new portlets: 

div(screenshot-wide). !/images/event_portlet_screenshot.png(Event Portlets Screen Shot)!:/images/event_portlet_screenshot.png 

p. And new category types:

div(screenshot-wide). !/images/event_category_screenshot.png(Event Category Type Screen Shot)!:/images/event_category_screenshot.png 
...
div(screenshot). !/images/events_list_screenshot.png(Events List Screen Shot)!:/images/events_list_screenshot.png 

div(screenshot). !/images/event_details_screenshot.png(Event Details Screen Shot)!:/images/event_details_screenshot.png 
...
div(screenshot). !/images/event_form_screenshot.png(Event Form Screen Shot)!:/images/event_form_screenshot.png 

div(screenshot). !/images/event_form_with_calendar_screenshot.png(Event Form With Calendar Screen Shot)!:/images/event_form_with_calendar_screenshot.png
...
div(screenshot). !/images/event_registration_form.png(Event Registration Form Screen Shot)!:/images/event_registration_form.png 
...
div(screenshot). !/images/event_registration_portlet_screenshot.png(Event Registration Portlet Form Screen Shot)!:/images/event_registration_portlet_screenshot.png 
...
div(screenshot). !/images/registration_page_screenshot.png(Event Registration Page Screen Shot)!:/images/registration_page_screenshot.png 

p. The result of the registration can be shown on the admin side under "Event Registration" in the content library. 

div(screenshot-wide). !/images/registration_result_screenshot.png(Event Registration Result Screen Shot)!:/images/registration_result_screenshot.png 
