...
div(screenshot). !/images/index_screenshot.png(Screen Shot of Default Index Page)!:/images/index_screenshot.png
...
div(screenshot). !/images/admin_login_screenshot.png(Screen Shot of Admin Login Page)!:/images/admin_login_screenshot.png

After signing in successfully you will notice the admin panel appear at the top of the page. 

div(screenshot-wide). !/images/admin_panel_screenshot.png(Admin Panel Screen Shot)!:/images/admin_panel_screenshot.png 
...
div(screenshot). !/images/layout_screenshot.png(Layout Screen Shot)!:/images/layout_screenshot.png 

p. And on the admin side:

div(screenshot). !/images/layout_screenshot_admin.png(Admin Layout Screen Shot)!:/images/layout_screenshot_admin.png 

p. Notice the icons at the top of the content:

div(screenshot-wide). !/images/content_panel.png(Content Panel Screen Shot)!:/images/content_panel.png 
...
div(screenshot-wide). !/images/back_to_top.png(Back To Top Screen Shot)!:/images/back_to_top.png 
